...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10"><a class="btn btn-primary btn-md" href="<s:url value="/editoriales/create"/>"><s:message
                code="editorial.nuevo"/></a>
            <br><br>
            <table class="table table-striped table-bordered table-hover"
                ...
                <tbody><c:forEach items="${listaEditoriales}" var="editorial">
                    <tr>
