    ...
    <div class="row">
        <div class="col-md-7">
            <f:form action="create" method="POST" modelAttribute="libro" >
                ...
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span><s:message code="requeridos"/></strong></div>
                <div class="form-group">
                    ...
                    <f:errors path="codigoLibro" cssClass="alert-danger alert"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <f:errors path="nombreLibro" cssClass="alert-danger alert"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <f:errors path="existencias" cssClass="alert-danger alert"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <f:errors path="precio" cssClass="alert-danger alert"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <f:select path="autoresByCodigoAutor.codigoAutor" cssClass="form-control" id="autor">
                            <f:options items="${listaAutores}" itemLabel="nombreAutor" itemValue="codigoAutor"/>
                        </f:select>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="editorial"><s:message code="editorial.nombre"/></label>
                    <div class="input-group">
                        <f:select path="editorialesByCodigoEditorial.codigoEditorial" cssClass="form-control"
                                  id="editorial">
                            <f:options items="${listaEditoriales}" itemLabel="nombreEditorial"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <f:select path="generosByIdGenero.idGenero" cssClass="form-control" id="genero">
                            <f:options items="${listaGeneros}" itemLabel="nombreGenero" itemValue="idGenero"/>
                        </f:select>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <f:button class="btn btn-info"><s:message code="guardar"/></f:button> <a class="btn btn-danger" href="<s:url value="/libros/list"/>"><s:message code="cancelar"/></a>
            </f:form>
        </div>
    </div>
</div>
